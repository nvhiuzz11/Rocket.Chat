...
const EditTaskModal = ({ onClose, taskProperties, task, reload, initialStatusProperty }: EditTaskModalProps): ReactElement => {
	...
	const createTaskEndpoint = useEndpoint('POST', '/v1/tasks.update');
	...
	const handleCreateTask = async ({ title, description, assignees, dueDate }: EditTaskModalPayload): Promise<void> => {
		try {
